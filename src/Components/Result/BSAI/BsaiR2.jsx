      ...
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          ...
          const subjects = [
            ...
            { name: "Data Structures", marks: student.dataStructures },
            { name: "Digital Logic Design", marks: student.dld },
            { name: "Islamic Studies", marks: student.islamicStudies }
