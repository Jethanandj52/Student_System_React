    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Statistics", marks: student.statistics },
            { name: "Discrete Structure", marks: student.discreteStructures },
            { name: "Computer Organization and Assembly Language", marks: student.coaa },
            { name: "Python", marks: student.python },
