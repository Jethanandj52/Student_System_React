    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Reinforcement Learning", marks: student.reinforcementLearning },
            { name: "Ai Robotics", marks: student.aiRobotics },
            { name: "Advanced CV", marks: student.advancedCV },
            { name: "Capstone 1", marks: student.capstone1 },
