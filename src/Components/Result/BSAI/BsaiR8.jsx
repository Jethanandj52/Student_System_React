    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Capstone 2", marks: student.capstone2 },
            { name: "MlOps", marks: student.mlOps },
            { name: "Data Ethics", marks: student.dataEthics },
            { name: "Viva", marks: student.viva },
            { name: "Internship", marks: student.internship }
