    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Data Structure Algo", marks: student.dsa },
            { name: "Operating System", marks: student.os },
            { name: "Data Science", marks: student.dataScience },
            { name: "Object Oriented Programming", marks: student.oop },
            { name: "Business Writing", marks: student.businessWriting }
