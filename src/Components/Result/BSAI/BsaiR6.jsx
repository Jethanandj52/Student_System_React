    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Deep Learning", marks: student.deepLearning },
            { name: "Natural Language Processing", marks: student.nlp },
            { name: "Data Science", marks: student.dataScience },
            { name: "Computer Vision", marks: student.cv },
            { name: "Ethics", marks: student.ethics }
