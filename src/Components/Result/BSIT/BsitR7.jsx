    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Cloud Computing", marks: student.cloudComputing },
            { name: "Information Security", marks: student.infoSecurity },
            { name: "Software Project Management", marks: student.spm },
            { name: "Human Computer Interaction", marks: student.hci },
            { name: "Internet of Things", marks: student.iot }
