    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Object Oriented Programming", marks: student.oop },
            { name: "Communication Skills", marks: student.communicationSkills },
            { name: "Electronics", marks: student.electronics },
            { name: "Discrete Mathematics", marks: student.discreteMaths },
            { name: "Pakistan Studies", marks: student.pakStudies }
