    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Data Warehousing", marks: student.dataWarehousing },
            { name: "IT Project Management", marks: student.projectManagement },
            { name: "Operating Systems", marks: student.operatingSystems },
            { name: "E-commerce", marks: student.ecommerce },
            { name: "Technical Writing", marks: student.technicalWriting }
