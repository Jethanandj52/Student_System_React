    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "FYP 2", marks: student.fyp2 },
            { name: "Professional Practice", marks: student.professional },
            { name: "Network Security", marks: student.networkSecurity },
            { name: "Data Science", marks: student.dataScience },
            { name: "Artificial Intelligence", marks: student.ai }
          ...
          return (
            <div key={index} className="mb-6 p-4 bg-white shadow rounded">
              <div className='flex justify-between mb-4'>
                ...
                <div><strong>Semester:</strong> 8</div>
