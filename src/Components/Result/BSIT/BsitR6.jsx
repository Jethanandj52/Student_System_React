    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Computer Graphics", marks: student.computerGraphics },
            { name: "Distributed Databases ", marks: student.distributedDatabases },
            { name: "MobileAppDev", marks: student.mobileAppDev },
            { name: "Professional Practice", marks: student.professionalPractices },
            { name: "Research Methods", marks: student.researchMethods }
          ...
          return (
            <div key={index} className="mb-6 p-4 bg-white shadow rounded">
              <div className='flex justify-between mb-4'>
                ...
                <div><strong>Department:</strong> BSIT</div>
              </div>
