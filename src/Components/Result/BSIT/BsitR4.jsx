      ...
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          ...
          const subjects = [
            ...
            { name: "Computer Networks", marks: student.networks },
            { name: "Database Management System", marks: student.dbms },
            { name: "Software Engineering", marks: student.softwareEngineering },
            { name: "Islamiat", marks: student.islPak }
