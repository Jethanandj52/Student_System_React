    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Compiler Construction", marks: student.compilerConstruction },
            { name: "Information Security", marks: student.informationSecurity },
            { name: "MachineLearning", marks: student.machineLearning },
            { name: "Parallel Computing", marks: student.parallelComputing },
            { name: "Software Management", marks: student.softwareProjectManagement },
          ];
          ...
          return (
            <div key={index} className="mb-6 p-4 bg-white shadow rounded">
              <div className='flex justify-between mb-4'>
                ...
                <div><strong>Semester:</strong> 6</div>
                <div><strong>Department:</strong> BSCS</div>
              </div>
<table className="w-full mt-4 text-sm text-center border border-gray-300 rounded-lg overflow-hidden">
  ...
  <tbody className="text-gray-800">
    ...
    <tr className="bg-gray-100 font-semibold">
      <td className="px-6 py-3 border border-gray-300">GPA</td>
      <td className="px-6 py-3 border border-gray-300 text-left">{gpa}</td>
         <td className="px-6 py-3 border border-gray-300">CGPA</td>
      <td className="px-6 py-3 border border-gray-300 text-left">{cgpa}</td>
    </tr>
