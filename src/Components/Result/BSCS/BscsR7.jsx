      ...
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          ...
          const subjects = [
            ...
            { name: "FYP 1", marks: student.fyp1 },
            { name: "Information Retrieval ", marks: student.informationRetrieval },
            { name: "Software Quaility Engineering", marks: student.softwareQualityEngineering },
          ];
          ...
          return (
            <div key={index} className="mb-6 p-4 bg-white shadow rounded">
              <div className='flex justify-between mb-4'>
                ...
                <div><strong>Semester:</strong> 7</div>
