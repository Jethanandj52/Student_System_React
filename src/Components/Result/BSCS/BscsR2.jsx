    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Communication", marks: student.communication },
            { name: "Discrete", marks: student.discrete },
            { name: "DLD", marks: student.dld },
            { name: "Islamic Studies", marks: student.islamic },
            { name: "Linear Algebra", marks: student.linearAlgebra },
            { name: "OOPS", marks: student.oop },
          ];
