    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "Computer Network", marks: student.computerNetworks },
            { name: "Data Base", marks: student.database },
            { name: "Design Analysis Algo", marks: student.designAnalysisAlgorithms },
            { name: "Differential Equation ", marks: student.differentialEquations },
            { name: "Human Computer Interaction", marks: student.hci },
            { name: "Operating System", marks: student.operatingSystems },
