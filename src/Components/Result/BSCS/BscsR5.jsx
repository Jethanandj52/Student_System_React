    ...
    <div className="bg-gray-100 p-4">
      {filteredData.length > 0 ? (
        filteredData.map((student, index) => {
          // Subject Marks
          const subjects = [
            { name: "AI", marks: student.artificialIntelligence },
            { name: "Automata Theory", marks: student.automataTheory },
            { name: "Mobile App Development", marks: student.mobileAppDevelopment },
            ...
            { name: "Web Engineering", marks: student.webTechnologies },
          ];
